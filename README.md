...
PHL_adm3
```
Each shapefile is comprised of four main file types: `.shp` contains the vector geometry, `.dbf` contains the attribute table, `.shx` the shape index, and `.prj` contains the coordinate systema dn projection information.
...
Ramos, L.T., Torres, A.M., Pulhin, F.B., Lasco, R.D. (2011) Developing a georeferenced database of selected threatened forest tree species in the Philippines. *Philippine Journal of Science*, 141(2):165-177. [(PDF)](http://philjournalsci.dost.gov.ph/pdf/pjs%20pdf/vol141no2/pdf/Developing_a_Georeferenced_Database.pdf)
